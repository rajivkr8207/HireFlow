...
export const RegisterCandidateController = asyncHandler(async (req, res) => {
    const { userId, headline, bio, education, city, state, country, pincode, certifications, skills, experience, resume, portfolio, github, linkedin } = req.body;
    const candidate = await RegisterCandidate({ userId, headline, bio, education, city, state, country, pincode, certifications, skills, experience, resume, portfolio, github, linkedin });
...
export const UpdateCandidateController = asyncHandler(async (req, res) => {
    const { userId, headline, bio, education, city, state, country, pincode, certifications, skills, experience, resume, portfolio, github, linkedin } = req.body;
    const candidate = await UpdateCandidate({ userId, headline, bio, education, city, state, country, pincode, certifications, skills, experience, resume, portfolio, github, linkedin });
