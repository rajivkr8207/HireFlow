...
export const CandidateRegisterValidate = [
    ...
    body("headline")
        ...
        .isLength({ min: 2, max: 250 }).withMessage("Headline must be between 2 and 250 characters"),
    body("bio")
        .trim()
    ...
    body("education")
        ...
        .isLength({ min: 2, max: 60 }).withMessage("Education must be between 2 and 60 characters"),
    body("city")
        .trim()
    ...
    body("certifications")
        .optional()
        .isArray().withMessage("Certifications must be an array of strings"),
    body("skills")
        .optional()
